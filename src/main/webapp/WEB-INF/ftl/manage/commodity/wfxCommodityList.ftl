...
<#assign footer>
	...
	<script src="/static/js/manage/commodity/wfxCommodityList.js?v=1.0"></script>
</#assign>
...
<div id="girdContent" class="row">
	<div class="col-xs-12">
		...
		<ul class="nav nav-tabs" id="myTab">
				<li class="active"><a  href="/commodity/wfxCommodityList.sc" >微分销商品库</a></li>
				<li class=""><a  href="/commodity/commodityList.sc" >优购商品库 </a></li>
		</ul>

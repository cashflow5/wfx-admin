...
<#assign footer>
	<!-- this page -->
	<script src="/static/js/manage/finance/alreadyIncomeStatementList.js"></script>
</#assign>
	...
	<div class="col-xs-12">
		<div class="tabbable">
        	<ul class="nav nav-tabs" id="myTab">
				<li class="active"><a data-toggle="tab" href="#alreadyIncomeStatementList" aria-expanded="true">收款报表</a></li>
			</ul>
        </div>
        <div class="tab-content">
        	<div id="alreadyIncomeStatementList" class="tab-pane fade active in">
        		<!-- 搜索表单，需自定义 -->
		                ...
		                <div class="row">
		                    <div class="col-sm-12">
		                        <div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" name="tradeStartTime" id="tradeStartTime" readonly="readonly" value="" class="input-medium" style="width:120px !important">
									    <label>至</label>
									    <input type="text" name="tradeEndTime" id="tradeEndTime" readonly="readonly" value="" class="input-medium" style="width:120px !important">
									</div>
		                        </div>
		                        <div class="form-group">
